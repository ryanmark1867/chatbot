...
- [characters](ranked_col) and [movies](ranked_col) played by [Sting](cast_name)
- [characters](ranked_col) and [movies](ranked_col) played by [Madonna](cast_name)
- [characters](ranked_col) with [movies](ranked_col) played by [Cher](cast_name)
